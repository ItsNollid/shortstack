...
import { ScheduleMatchBanner } from '../components/ScheduleMatchBanner';
...
export function Banners(): React.JSX.Element | null {
  ...
  const banners: React.JSX.Element[] = [<UpdateBanner key="update" />, <ScheduleMatchBanner key="schedule-match" />];
